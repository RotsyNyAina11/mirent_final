  ...
  const availableCars: Car[] = [
    {
      ...
      status: "Disponible",
      image:
        "https://public.readdy.ai/ai/img_res/1f95fa58a2098a165a8a7af87f6f2cbb.jpg",
    },
    {
      id: 2,
      name: "Renault Clio",
      status: "Disponible",
      image:
        "https://public.readdy.ai/ai/img_res/284918923d6fcad08f717cc628eb3d99.jpg",
    },
  ];
  ...
  return (
    <Box display="flex" height="100vh">
      ...
      <Box flexGrow={1} overflow="auto">
        ...
        <Box p={4} pt={10}>
          {" "}
          {/* Ajout de padding-top pour compenser la hauteur de l'en-tête */}
            ...
            <Grid item xs={12} md={8}>
              <Paper elevation={3} sx={{ p: 3 }}>
                <Typography variant="h6" gutterBottom>
                  Performance{" "}
                  <TrendingUpIcon sx={{ verticalAlign: "middle", ml: 1 }} />
                </Typography>
                <Box
                  sx={{
                    height: 300,
