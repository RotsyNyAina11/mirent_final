      ...
      <Box sx={{ backgroundColor: '#f9fafb', minHeight: '100vh' }}>
        ...
        <Grid container spacing={3} mb={isMobile ? 2 : 4}>
          <Grid item xs={12}>
            ...
            <Typography variant="body1" sx={{ fontSize: '0.9rem', color: '#6b7280' }}>
              Remplissez les informations ci-dessous pour créer un nouveau proforma pour un client.
            </Typography>
          </Grid>
        </Grid>
        ...
        <DashboardCard sx={{ p: isMobile ? 2 : 3 }}>
          <form onSubmit={handleSubmit}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth error={!!formErrors.clientId}>
                  ...
                  <Select
                    ...
                    onChange={(e: SelectChangeEvent<string | number>) => handleChange(e)}
                    label="Client"
                    sx={{
                      borderRadius: '8px',
                      '& .MuiSelect-select': {
            ...
            {/* Boutons d'action */}
            <Box sx={{ mt: isMobile ? 2 : 3, display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
              <CancelButton
                variant="outlined"
