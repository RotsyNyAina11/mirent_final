...
const mockVehicles: Vehicle[] = [
    ...
    // ... autres véhicules avec images multiples et status
];

// Styled components for better visual distinction
...
const StatusChip = styled(Chip)<StatusChipProps>(({ status }) => ({
    ...
    ...(status !== "Disponible" && status !== "Réservé" && {
        backgroundColor: '#ffebee',
        color: '#d32f2f',
    }),
}));

const PrimaryButton = styled(motion.div)(({ theme }) => ({
    '& .MuiButton-contained': {
...
const SecondaryButton = styled(motion.div)(({ theme }) => ({
    '& .MuiButton-outlined': {
...
// Sous-composant pour le carrousel d'images (no changes needed here)
const ImageCarousel: React.FC<{ images: string[] }> = ({ images }) => {
    ...
    return (
        <Box sx={{ position: "relative", height: 400, overflow: "hidden", borderTopLeftRadius: 4, borderTopRightRadius: 4 }}>
            <AnimatePresence>
                <motion.img
                    key={currentImage}
...
// Sous-composant pour les caractéristiques (using styled component)
                    ...
                    >
                        ...
                        <CardContent sx={{ p: { xs: 3, md: 5 } }}>
                            ...
                            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, mb: 3 }}>
                                ...
                                />
                                <StatusChip status={vehicle.status} label={vehicle.status} />
                            </Box>
                            <Typography
                                variant="body1"
                            ...
                            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
                                <PrimaryButton variants={buttonVariants} whileHover="hover" whileTap="tap">
                                    <Button
                                        variant="contained"
                                ...
                                <SecondaryButton variants={buttonVariants} whileHover="hover" whileTap="tap">
                                    <Button
                                        variant="outlined"
                                        onClick={() => navigate("/list-vehicule")}
                                    >
