...
const mockVehicles = [
  {
    ...
    description:
      "La Toyota Corolla est une berline fiable et économique, parfaite pour les trajets urbains et les longues distances. Équipée d'un moteur hybride, elle offre un excellent rendement énergétique.",
    features: [
      "Climatisation",
      "Système hybride",
      "Caméra de recul",
  ...
  },
  {
    ...
    image: "/src/assets/1.jpg",
    description:
      "La Honda Civic combine style et performance avec une conduite dynamique. Idéale pour ceux qui recherchent confort et technologie.",
    features: [
      "Écran tactile",
  ...
  },
  {
    ...
    image: "/src/assets/1.jpg",
    description:
      "La BMW Série 3 offre une expérience de conduite premium avec des finitions haut de gamme et des technologies avancées.",
    features: [
  ...
  },
  {
    ...
    image: "/src/assets/1.jpg",
    description:
      "La Mercedes Classe C est synonyme de luxe et de confort, avec des équipements de pointe et une conduite fluide.",
    features: [
      "Sièges électriques",
  ...
  },
  {
    ...
    image: "/src/assets/1.jpg",
    description:
      "Le Volkswagen Tiguan est un SUV polyvalent, idéal pour les familles et les aventures en plein air, avec un espace généreux.",
    features: [
      "4x4",
      "Coffre spacieux",
      "Écran multifonction",
  ...
  },
  {
    ...
    image: "/src/assets/1.jpg",
    description:
      "L'Audi Q5 allie élégance et robustesse, avec des performances tout-terrain et un intérieur raffiné.",
    features: [
      "Quattro 4x4",
      "Toit panoramique",
...
const VehicleDetails: React.FC<{
  vehicle: (typeof mockVehicles)[0] | null;
  onClose: () => void;
}> = ({ vehicle, onClose }) => {
  ...
  if (!vehicle) {
    return (
      <Box sx={{ p: 4, bgcolor: "#fff", borderRadius: 8, textAlign: "center" }}>
        ...
        <Typography
          variant="h6"
          sx={{ color: "#0f172a", mb: 2, fontFamily: "'Inter', sans-serif" }}
        >
          Véhicule non trouvé
        </Typography>
        <Button
      ...
      >
        <Box sx={{ position: "relative" }}>
          ...
          <CardMedia
            ...
            image={
              vehicle.image ||
              "https://via.placeholder.com/500x200?text=Image+Indisponible"
            }
...
const VehiclesPage: React.FC = () => {
  ...
  const filteredVehicles = mockVehicles.filter((vehicle) => {
    const matchesBrand =
      brandFilter === "Toutes" || vehicle.brand === brandFilter;
    const matchesType = typeFilter === "Tous" || vehicle.type === typeFilter;
    const matchesStatus =
      statusFilter === "Tous" || vehicle.status === statusFilter;
        ...
        <Grid container spacing={{ xs: 2, md: 3 }}>
          {isLoading ? (
            ...
            <Box sx={{ width: "100%", textAlign: "center", py: 10 }}>
              ...
              >
                Modifiez vos filtres ou réinitialisez-les pour voir plus de
                résultats.
              </Typography>
            </Box>
          )}
