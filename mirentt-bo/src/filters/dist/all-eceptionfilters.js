...
var AllExceptionsFilter = /** @class */ (function () {
    ...
    AllExceptionsFilter.prototype["catch"] = function (exception, host) {
        ...
        var status = exception.status || 500; // Si exception n'a pas de status, utilise 500
        var message = exception.message || 'Internal server error'; // Message par défaut si pas d'erreur précise
